...
use reth_node_core::args::{BitfinityArgs, DatabaseArgs};
...
impl Command {
    ...
    pub async fn execute(self, _ctx: CliContext) -> eyre::Result<()> {
        let ethereum_json_client = ethereum_json_rpc_client::EthJsonRpcClient::new(
            ReqwestClient::new(self.bitfinity.rpc_url.clone()),
        );
        ...
        let latest_block = ethereum_json_client.get_block_number().await.map_err(|e| {
